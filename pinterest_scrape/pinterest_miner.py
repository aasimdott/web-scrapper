...
print(f"[SYSTEM] Initializing Harvesting Sequence for: '{search_target}'")

with sync_playwright() as p:
    context = p.chromium.launch_persistent_context(user_data_dir=PROFILE_DIR, headless=False, executable_path="/usr/bin/chromium", proxy={
